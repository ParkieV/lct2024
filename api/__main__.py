...
## /v1/ml/forecast/forecast_next_purchase
Прогнозирование следующей закупки выбранного товара

Возвращает json с датой начала/окончания закупки, суммой, и количеством

**Возвращает код 404, если товар нерегулярный и по нему нельзя получить прогноз**
        """,
    },
    {
